...
- `v2.FullPlayerV2`, `FullPlayerV2Content`, `FullPlayerV2Sheets`, `ControlDeck`, and `ControlDeckQuickActions` provide full-player presentation pieces. Tapping download on an already-downloaded episode prompts with `RemoveDownloadConfirmationDialog` before removing local audio.
